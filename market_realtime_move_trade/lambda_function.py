...
def lambda_handler(event, context):
    ...
    return {
        'statusCode': 200,
        'body': json.dumps(start_task('trading', 'market_realtime_move_report_kinesis', 'market_realtime_move_report_kinesis:2',
          ['java', '-jar', 'market_realtime_move_report_kinesis-1.0-SNAPSHOT.jar', '--shardid=0', '--apptype=changes_anomaly_trading']))
    }
